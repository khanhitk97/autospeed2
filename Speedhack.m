...
// ==========================================
// SPEEDHACK ENGINE (INCREMENTAL ACCUMULATOR)
// ==========================================

static float speed_factor = 5.0f; // Mặc định khởi chạy 5.0x
...
// Biến lưu mốc thời gian vi phân
